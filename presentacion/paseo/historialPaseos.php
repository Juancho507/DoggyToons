        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    echo $cantidadPaseos . " paseo" . ($cantidadPaseos !== 1 ? "s" : "") . " encontrado" . ($cantidadPaseos !== 1 ? "s" : "");
                    ...
                    if (empty($historialPaseos)) {
                        ...
                        echo "<thead><tr><th>Id Paseo</th><th>Fecha Inicio</th><th>Fecha Fin</th><th>Paseador</th><th>Estado</th></tr></thead>";
                        echo "<tbody>";
                        foreach($historialPaseos as $paseoItem){
                            ...
                            echo "<td class='align-middle'>" . htmlspecialchars($paseoItem->getNombrePaseador()) . "</td>";
